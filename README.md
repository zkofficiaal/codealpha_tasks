# CodeAlpha Internship Tasks — May Batch

This repository contains my completed **App Development tasks** for the CodeAlpha Internship Program.  
I have implemented three projects with clean SwiftUI code, professional UI design, and exam‑ready structure.
...
- Simple, user‑friendly design for study sessions  
...
- Clean and professional single‑file SwiftUI implementation  
...
- List view of activities for quick tracking  
